...
const initialHUD: BattleHUD = {
  ...
  heroAlive: true, heroRespawn: 0, nextWaveIn: 10, skillCooldowns: {}, speed: 1,
};
...
export function RealmGuardGame({ onStart, onTelemetry, onAuthoritativeComplete, isRecording, preview }: RealmGuardGameProps) {
  ...
  if (phase === 'select') return <Box sx={{ width: '100%', maxWidth: 1280, mx: 'auto', p: { xs: 1, md: 2 } }}>
    <Paper sx={{ position: 'relative', aspectRatio: '16 / 9', minHeight: { xs: 620, lg: 0 }, overflow: 'auto', p: { xs: 2, md: 3 }, background: 'radial-gradient(circle at 78% 10%,rgba(111,79,174,.26),transparent 32%),linear-gradient(145deg,#102b2c,#101627 62%,#261b36)' }}>
