...
export function RealmGuardGame({ onStart, onTelemetry, onAuthoritativeComplete, isRecording, preview }: RealmGuardGameProps) {
  ...
  return <Box data-testid="realmguard-battle-shell" sx={{ width: '100%', maxWidth: 1280, mx: 'auto', position: 'relative', aspectRatio: '16 / 9', bgcolor: '#09131f', overflow: 'hidden', userSelect: 'none', [portraitBattleMedia]: { aspectRatio: 'auto', minHeight: 760 } }}>
