...
export function EventsPage() {
  ...
  const { data, loading, error, setData } = useAsync(() => api.request<{ items: EventItem[] }>('/api/v1/events'), []);
