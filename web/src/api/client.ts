...
function normalizeGame(game: Game): Game {
  return {
    ...
    game_type: game.game_type === 'embedded' && ['2048', 'snake', 'memory', 'reaction', 'typing', 'realmguard', 'office-guardians', 'cyber-fortress', 'ai-nexus-defense'].includes(game.slug || game.id) ? 'builtin' : game.game_type,
  };
}
